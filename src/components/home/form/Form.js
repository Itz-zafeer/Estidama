        ...
        <section>
            <div className='Container1640 pb220 relative'>
                <div className='lg:w-[42.1875vw] w-full mx-[auto]'>
                    ...
                    <ErrorMsg />
                    <SuccessMsg />
                    <form onSubmit={handelFormSubmit} id='contactForm' className='w-full mt56'>
                        <InputElements inputsData={inputsData} />
                        <button className={`mt56 mx-[auto] block uppercase text24 hover:bg-[#132D2B] transition-all duration-300 bg-[#5EBD8E] border100 lg:px-[3.02604166667vw] lg:py-[0.52083333333vw] py-[8px] px-[35px] sm:py-[10px] sm:px-[40px] text-white`}>
                            ارسل
                        </button>
                    </form>
                </div>
