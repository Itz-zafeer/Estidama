...
const SmallCard = ({ date, heading, link }) => {
    return (
        <div className='flex flex-wrap sm:gap-y-[25px] gap-y-[20px] lg:gap-x-[2.1875vw] items-center'>
            <div className='relative lg:w-[12.3958333333vw] lg:h-[11.1458333333vw] sm:w-[60%] w-[50%] h-[150px] sm:h-[250px]'>
                <Image fill src='/images/home/news/smallcard/1.jpg' alt='news' className='border20 object-cover' />
            </div>
            <div className='lg:w-[19.7916666667vw]  '>
                <span className='text18'>{date}</span>
                <h4 className='text29 mt12 f700 line-clamp-2 lg:h-[3.75vw]'>{heading}</h4>
                <Link href='/news' className='newsLink text-[#5EBD8E] mt32 flex items-center lg:items-end lg:gap-x-[0.52083333333vw] sm:gap-x-[10px] gap-x-[8px]'>
